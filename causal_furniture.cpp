    ...
    causal(causal)
{
    ...
    //Discount = 0.95;
    names = { "chimney","wick", "burner", "kerosene", "fuel tank","lighter"};
...
{
    std::vector<std::pair<std::string, std::string>> validconnections{ std::make_pair("kerosene", "burner"),std::make_pair("burner", "lighter"),std::make_pair("fuel tank", "burner"),std::make_pair("lighter", "fuel tank"),std::make_pair("lighter", "kerosene"),std::make_pair("kerosene", "fuel tank"),std::make_pair("wick", "burner"),std::make_pair("wick", "lighter"),std::make_pair("wick", "kerosene"),std::make_pair("wick", "fuel tank"),std::make_pair("wick", "chimney")};
    auto it3 = std::find_if(validconnections.begin(), validconnections.end(), [&](std::pair<std::string, std::string> obj) { return ((obj.first == connection.first) && (obj.second == connection.second)); });
    auto it4 = std::find_if(validconnections.begin(), validconnections.end(), [&](std::pair<std::string, std::string> obj) { return ((obj.first == connection.second) && (obj.second == connection.first)); });
