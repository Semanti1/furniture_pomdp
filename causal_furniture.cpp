    ...
    causal(causal)
{
    ...
    //Discount = 0.95;
    names = { "batteries","switchandcircuit", "lightbulb", "lens"};
...
{
    std::vector<std::pair<std::string, std::string>> validconnections{ std::make_pair("batteries", "switchandcircuit"),std::make_pair("batteries", "lightbulb"), std::make_pair("lightbulb","switchandcircuit"), std::make_pair("lens","lightbulb")};
...
{
    std::vector<std::pair<std::string, std::string>> validconnections{ std::make_pair("lightbulb", "switchandcircuit"),std::make_pair("batteries", "switchandcircuit"),std::make_pair("batteries", "lens"),std::make_pair("lens", "switchandcircuit"),std::make_pair("batteries", "lightbulb"),std::make_pair("lightbulb", "lens")};
    auto it3 = std::find_if(validconnections.begin(), validconnections.end(), [&](std::pair<std::string, std::string> obj) { return ((obj.first == connection.first) && (obj.second == connection.second)); });
    auto it4 = std::find_if(validconnections.begin(), validconnections.end(), [&](std::pair<std::string, std::string> obj) { return ((obj.first == connection.second) && (obj.second == connection.first)); });
